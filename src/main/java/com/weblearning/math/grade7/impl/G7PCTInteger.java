...
public class G7PCTInteger extends GenericQuestion{
	...
	private Problem getProblem(MathConfiguration mathConfig){
		...
		String question = numerator + " % of " + num2; 
		
		//String answer = MathUtilities.convertSingleFRactionToString(num1*5, 100);
		Fraction rFrac = Fraction.getReducedFraction(numerator*num2 , 100);
		...
		//add the questions
		QuestionLine qLine1 = new QuestionLine(mSource.getMessage(Constants.CALCULATE_INTEGER_PERCENTAGE, null, Locale.ENGLISH));
