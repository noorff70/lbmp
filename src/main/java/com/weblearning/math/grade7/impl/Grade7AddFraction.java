...
public class Grade7AddFraction extends GenericQuestion {
	...
	public Problem getProblem1(MathConfiguration mathConfig, int i) {
		...
		Fraction result1 = frac1a.add(frac1b);
		...
		Fraction result2 = frac2a.add(frac2b);
		...
		Fraction result3 = frac3a.add(frac3b);
		...
		Fraction result4 = frac4a.add(frac4b).add(frac4c);
		...
		Fraction result5 = frac5a.add(frac5b);
		//result3 = Fraction.getReducedFraction(result3.getNumerator(), result3.getDenominator());
		...
		questionList.add(new QuestionLine( mSource.getMessage(GR7_Constants.ADD_THE_FOLLOWING_FRACTIONS, null, Locale.ENGLISH), null, Constants.DEFAULT));
