...
public class FracWordProblem1 extends GenericQuestion{
	...
	public List<?> getQuestions(MathConfiguration mathConfig) {
	    ...
	    Resource baseresource = resourceLoader.getResource( "classpath:/locale/math/grade7/problems/FractionWordProblem/FractionWordProblem.xml" );
