...
public class G7Triangles2 extends GenericQuestion{
	...
	public Problem getProblem1(MathConfiguration mathConfig) {
		...
		String ans4 = "Equilateral";
		String ans5 = "Isosceles right";
	...
	public Problem getProblem3(MathConfiguration mathConfig) {
		...
		question = "What type of Triangle is ABC when it has the following conditions?";
		q2 = "BC > AC > AB";
	...
	public Problem getProblem4(MathConfiguration mathConfig) {
		...
		question = "What type of Triangle is ABC when none of the angles are more than 90 and has the following conditions?";
		q2 = "$\\angle A \\neq \\angle B \\neq \\angle C$";
	...
	public Problem getProblem6(MathConfiguration mathConfig) {
		...
		questionList.add(new QuestionLine(  "$\\angle EFB$ ="+ GR8_Constants.ANSWER_TO_QUESTION + EFC  ,  null, Constants.PROBLEM_TYPE_MULTIPLE_QUESTIONS));
	...
	public Problem getProblem7(MathConfiguration mathConfig) {
		...
		int a = MathUtilities.getRandomNumber(40, 50);
		BigDecimal b = new BigDecimal((double)MathUtilities.getRandomNumber(300, 400)/10).setScale(2, RoundingMode.HALF_UP);

		BigDecimal ans = new BigDecimal(180-a-b.doubleValue()).setScale(2, RoundingMode.HALF_UP);	
		question = "What would be the other angle to make it a triangle?" ;

		questionList.add( new QuestionLine( question, null, Constants.DEFAULT));

		String heading = mSource.getMessage(GR7_Constants.COORDINATE_GEOMETRY, null, Locale.ENGLISH);
		answ.setAnswer(ans.toString());
