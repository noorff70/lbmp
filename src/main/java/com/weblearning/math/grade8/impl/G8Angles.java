...
public class G8Angles extends GenericQuestion {
	...
	public Problem getProblem3(MathConfiguration mathConfig) {
		...
		String coordinateLabelA, coordinateLabelB, coordinateLabelC, coordinateLabelD, coordinateLabelE = "";
		String cAngleLabelA, cAngleLabelB, cAngleLabelC, cAngleLabelD, cAngleLabelE = "";
		...
		coordinateLabelD = "[" + getXYLabels(dX, "Center_X") + "," + getXYLabels(dY, "Upper_Y") + "]";
		coordinateLabelE = "[" + getXYLabels(eX, "Center_X") + "," + getXYLabels(eY, "Upper_Y") + "]";
		
		cAngleLabelA = "[-.5" + "," + ".5" + "]";
		cAngleLabelB = "[1" + "," + "3" + "]";
		cAngleLabelC = "[.75" + "," + "1.5" + "]";
		//cAngleLabelD = "[" + getCoordinate(dX, "Center_X") + "," + getCoordinate(dY, "Upper_Y") + "]";
		//cAngleLabelE = "[" + getCoordinate(eX, "Center_X") + "," + getCoordinate(eY, "Upper_Y") + "]";
	...
	int getAxisRange(int coordinate, String type) {
	...
	String getXYLabels (int coordinate, String type) {
