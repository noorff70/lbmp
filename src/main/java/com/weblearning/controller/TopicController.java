...
public class TopicController{
	...
	public UIObject topics(@RequestParam("GRADEID") String gradeId, @RequestParam("SUBJECTID") String subjectId, HttpServletRequest request) {
		...
		if (null != uiObject){
			...
			if (null != topicList && topicList.size()>0)
			{
				...
				//if the current subject and gradeid match with session, then return the same object
